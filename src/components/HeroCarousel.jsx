...
const HeroCarousel = () => {
  return (
    <div className="relative w-full md:max-w-7xl mx-auto h-[200px] sm:h-[280px] md:h-[400px] lg:h-[500px] overflow-hidden sm:rounded-2xl md:shadow-2xl bg-black">
      <Swiper
      ...
      >
        <svg
          className="w-5 h-5 md:w-6 md:h-6 text-[#FE7704]"
          fill="none"
          stroke="currentColor"
          strokeWidth="2.5"
          viewBox="0 0 24 24"
